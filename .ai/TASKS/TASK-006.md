# TASK-006: Implement bootstrap pairing and device tokens

## Goal

Implement OTA bootstrap, six-digit pairing, atomic claim, activation polling, and identity-bound device token issuance.
...
apps/control-api/src/modules/devices/, pairing/, firmware/
...
Simulator observes code, 202, claim, 200, re-bootstrap, and scoped token; race and expiry tests pass.
