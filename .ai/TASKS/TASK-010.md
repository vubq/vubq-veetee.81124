# TASK-010: Implement provider management

## Goal

Add catalog, instances, encrypted credentials, key pools, pipeline profiles, revisions, health, and runtime snapshots.
...
apps/control-api/src/modules/providers/, pipelines/
...
Secrets are write-only/encrypted; redaction and revision tests pass; realtime receives bounded snapshots.
