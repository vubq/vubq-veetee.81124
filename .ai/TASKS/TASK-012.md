# TASK-012: Implement firmware release management

## Goal

Add artifact storage, SHA-256, board/version policy, publication, scoped downloads, and safe update decisions.
...
apps/control-api/src/modules/firmware/
...
Wrong-board images never offered; ticket expiry/scope enforced; force update audited and confirmed.
